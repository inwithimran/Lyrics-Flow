...
<div class="absolute inset-0 rounded-full pointer-events-none ring-1 ring-inset ring-white/15 shadow-[inset_0_0_20px_rgba(0,0,0,0.6)]"></div>
        ...
        <!-- Center Hole & Ring -->
        <div class="w-9 h-9 xl:w-11 xl:h-11 rounded-full border-2 border-slate-950 shadow-2xl flex items-center justify-center absolute z-10 bg-slate-900/85 backdrop-blur-xs">
...
<button data-studio-tab="tab-prefs" data-scroll-to="visualizer-section" class="p-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 text-slate-300 flex items-center justify-center gap-2 transition-all active:scale-95 shadow-sm">
    ...
    <div class="max-w-6xl mx-auto space-y-3">
        ...
        <div class="flex sm:hidden items-center justify-between px-1.5">
            ...
            <button id="btn-sleep-mob" data-studio-tab="tab-prefs" data-scroll-to="sleep-timer-section" class="ctrl-btn w-8 h-8" title="Sleep Timer" aria-label="Sleep Mode Timer">
                <i class="fa-solid fa-clock text-base text-white" id="sleep-mob-icon"></i>
                <span id="sleep-mob-countdown-text" class="hidden text-[10px] font-mono font-bold text-amber-300 leading-none">00:00</span>
            </button>
        ...
        <div class="hidden sm:grid sm:grid-cols-3 items-center gap-4 px-2 w-full">
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <div class="flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl">
                    <button id="btn-mute" class="text-slate-300 hover:text-white w-4 flex items-center justify-center shrink-0" aria-label="Mute or unmute">
